    ...
    <section class="bg-gray-100">
      <div class="bg-gray-100">
        ...
        */}
            ...
            <a target="_blank noopener noreferrer" href="https://permacast.app" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black bg-[#ffff00] hover:drop-shadow-xl focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
